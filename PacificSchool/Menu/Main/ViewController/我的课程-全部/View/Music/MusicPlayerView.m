...
- (void)initUI {
    ...
    [self.timeNowLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.equalTo(weakself.timeTotalLabel.mas_left).offset(0);
    ...
    [self.timeSlider mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(self.playButton.mas_right).offset(8);
        make.right.equalTo(weakself).offset(-8);
    ...
    self.imageView.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.5];
}
...
- (UILabel *)timeNowLabel {
    if (!_timeNowLabel) {
        ...
        _timeNowLabel.textColor = [UIColor grayColor];
...
-(UILabel *)timeTotalLabel {
    if (!_timeTotalLabel) {
        ...
        _timeTotalLabel.textColor = [UIColor grayColor];
...
- (ProgressSlider *)timeSlider {
    if (!_timeSlider) {
        ...
        _timeSlider.playProgressColor = [kMainColor colorWithAlphaComponent:0.7];
        _timeSlider.bufferProgressColor = [UIColor grayColor];
        _timeSlider.sliderBackgoundColor = [UIColor groupTableViewBackgroundColor];
    }
    return _timeSlider;
}
@end
